...
parser.add_argument('--bal', required=True, help='enter starting balance')
parser.add_argument('--payday', required=True, help='enter numerical day of your next paycheck')
parser.add_argument('--avgWeeklyExp', help='True/False include average weekly expenses', default=True)
